...
<ToastContainer style={{zIndex:50000000000}}/>
            <div>
                {
                    cartData.map((el,index)=>{
                        return <div className = "cartEle" key={index+1}>
                            ...
                            <p>Rs.{el.best_price}</p>
                            <div style={{display:"flex",flexDirection:"row",gap:"10px"}}>
                                <button className="dec" disabled = {el.quantity === 0 ? true : false} onClick={()=>decreaseCount(index)}>-</button>
                            ...
                            <p>Rs.{Math.round(el.best_price*el.quantity * 100) / 100}</p>
        ...
        <div className="subtotal">
            ...
            <div style={{display:"flex",flexDirection:"row",width:"38%",gap:"80px"}} >
                <p>Cart Subtotal : </p> 
                <p>Rs.{Math.round(totalPrice * 100)/100}</p>
            </div>
        </div>
