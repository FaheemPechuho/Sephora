...
const navigate = useNavigate();
    ...
    return (
        <>
           ...
           >
           <h3>New Collection Exclusively for Pakistan</h3>


                     <div className="outer">
                        <div className="inner"  onClick={()=> handleCatClick("Lipcare")}>
                            <div className='testing'>
                            <img src="https://www.sephora.com/productimages/sku/s2729986-main-zoom.jpg?imwidth=612" alt="Not found" />
                            </div>
                            <h5>Lip Care</h5>
                        </div>
                        ...
                        <div className="inner" onClick={()=> handleCatClick("Perfumes")}>
                            <div className='testing'>
                            <img src='https://www.sephora.com/productimages/sku/s2327278-main-zoom.jpg?imwidth=612' alt="Not found" />
                            </div>
                            <h5>Perfumes</h5>
                        </div>
